...
// let sumWithX = TensorMath.new.pow(2).sqrt().finish // easeInOut().constrain(0.5).finish//deadWidth(20).binarize(700).toFixed(2).finish

// // console.log(sumWithX(-9.9))

// let output = TensorMath.buildTensor(-1, 1, 0.01).apply(sumWithX)
// // let output = tensor.map(sumWithX)
